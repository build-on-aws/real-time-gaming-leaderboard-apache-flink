...
sudo docker run -d -p 3306:3306 --name db -e MYSQL_USER=admin -e MYSQL_DATABASE=gaming -e MYSQL_PASSWORD="$PASSWORD" -e MYSQL_ROOT_PASSWORD="$PASSWORD" -v /home/ec2-user/init:/docker-entrypoint-initdb.d mysql:8.0
